        ...
        <form action="<?php echo url('/admin/users/' . escape($user->id) . '/update'); ?>" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" value="<?php echo escape(old('phone', $user->phone ?? '')); ?>">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="major_id" name="major_id">
                        ...
                        <?php foreach ($majors as $major): ?>
                            <option value="<?php echo escape($major->id); ?>" <?php echo (old('major_id', $user->major_id ?? '') == $major->id) ? 'selected' : ''; ?>>
