<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <div>
        <h4 class="fw-bold mb-1"><i class="fas fa-plus-circle ms-2 text-primary"></i>إضافة مستوى جديد</h4>
        <p class="text-muted small mb-0">إضافة مستوى دراسي جديد</p>
    </div>
    <div>
...
<div class="card shadow-sm">
    <div class="card-body">
        <form action="<?php echo url('/admin/levels/store'); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="level_number" name="level_number" value="<?php echo escape(old('level_number')); ?>">
                </div>
                <div class="col-md-4">
